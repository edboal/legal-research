...
declare const sanitizeUrl: (url: string | undefined, { allowedSchemes, permitInvalid }: SanitizeUrlOptions) => null | string;
...
export { type AnyFunction, type AnyObject, type DeepPartial, type DeepPartialAny, type DeepRequired, type FunctionProperties, type FunctionPropertyNames, IS_APPLE, type Modify, type ModifyDeep, type OmitFirst, type PartialExcept, type PartialPick, type SanitizeUrlOptions, type Simplify, type UnionToIntersection, type UnknownObject, type WithOptional, type WithPartial, type WithRequired, bindFirst, escapeRegExp, findHtmlParentElement, getHandler, hexToBase64, isDefined, isNull, isUndefined, isUndefinedOrNull, isUrl, mergeProps, sanitizeUrl };
