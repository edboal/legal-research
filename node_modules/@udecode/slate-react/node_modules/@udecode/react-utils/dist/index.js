...
var useOnClickOutside = (callback, {
  ...
  const [refsState, setRefsState] = import_react10.default.useState([]);
  const callbackRef = import_react10.default.useRef(callback);
  callbackRef.current = callback;
  const ref = import_react10.default.useCallback(
...
var withProviders = (...providers) => (WrappedComponent) => (props) => providers.reduceRight(
  (acc, prov) => {
    ...
    if (Array.isArray(prov)) {
      [Provider] = prov;
      return /* @__PURE__ */ import_react12.default.createElement(Provider, __spreadValues({}, prov[1]), acc);
    }
    return /* @__PURE__ */ import_react12.default.createElement(Provider, null, acc);
  },
  /* @__PURE__ */ import_react12.default.createElement(WrappedComponent, __spreadValues({}, props))
);
