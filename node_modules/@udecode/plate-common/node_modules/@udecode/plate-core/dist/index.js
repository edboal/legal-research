...
__export(src_exports, {
  ...
  SlateLeaf: () => SlateLeaf,
  SlateNextPlugin: () => SlateNextPlugin,
  TAB: () => TAB,
  ZERO_WIDTH_SPACE: () => ZERO_WIDTH_SPACE,
  applyDeepToNodes: () => applyDeepToNodes,
  applyPluginsToEditor: () => applyPluginsToEditor,
  ...
  pipeInjectNodeProps: () => pipeInjectNodeProps,
  pipeInsertDataQuery: () => pipeInsertDataQuery,
  pipeInsertFragment: () => pipeInsertFragment,
  pipeNormalizeInitialValue: () => pipeNormalizeInitialValue,
  ...
  pluginInjectNodeProps: () => pluginInjectNodeProps,
  ...
  resolveAndSortPlugins: () => resolveAndSortPlugins,
  resolveCreatePluginTest: () => resolveCreatePluginTest,
  resolvePlugin: () => resolvePlugin,
  resolvePluginOverrides: () => resolvePluginOverrides,
  resolvePluginTest: () => resolvePluginTest,
...
var withInlineVoid = ({ editor }) => {
  const { isInline: isInline2, isVoid: isVoid2, markableVoid } = editor;
  const voidTypes = [];
  const inlineTypes = [];
  ...
  editor.isVoid = (element) => {
    return voidTypes.includes(element.type) ? true : isVoid2(element);
  };
...
var SlateElement = (props) => {
  ...
  const block = !!element.id && (0, import_slate10.isBlock)(props.editor, element);
  const rootProps = {
    ...attributes,
    ...rest,
    ...nodeProps,
    ...elementToAttributes?.(element),
    className: (0, import_clsx2.default)(props.className, nodeProps?.className),
...
var getRenderNodeStaticProps = ({
  ...
  nodeProps = pipeInjectNodeProps(
    editor,
    nodeProps,
    (node) => (0, import_slate11.findNodePath)(editor, node)
  );
...
var pluginRenderElementStatic = (editor, plugin, components) => function render(nodeProps) {
  if (nodeProps.element.type === plugin.node.type) {
    ...
    let component = /* @__PURE__ */ import_react2.default.createElement(Element, { ...nodeProps }, children);
...
function SlateLeaf(props) {
  ...
  const Leaf = as ?? "span";
  return /* @__PURE__ */ import_react4.default.createElement(Leaf, { ...rootProps });
}
...
var pluginRenderLeafStatic = (editor, plugin, components) => function render(nodeProps) {
  ...
  if (leaf[plugin.node.type ?? plugin.key]) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement(Leaf, { ...ctxProps }, children);
  }
  return children;
};
var pipeRenderLeafStatic = (editor, {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react5.default.createElement(SlateLeaf, { ...ctxProps });
  };
};
...
function ElementStatic({
  ...
  if ((0, import_slate12.isVoid)(editor, element)) {
  ...
  if ((0, import_slate12.isInline)(editor, element)) {
    attributes["data-slate-inline"] = true;
  }
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, renderElement?.({
    attributes,
    children,
    element
  }));
...
function LeafStatic({
  ...
  const leaves = import_slate13.Text.decorations(leaf, decorations);
  return /* @__PURE__ */ import_react6.default.createElement("span", { "data-slate-node": "text" }, leaves.map((l, index) => {
    const leafElement = renderLeaf({
      attributes: { "data-slate-leaf": true },
      children: /* @__PURE__ */ import_react6.default.createElement("span", { "data-slate-string": true }, l.text === "" ? "\uFEFF" : l.text),
      leaf: l,
      text: l
    });
...
function Children({
  ...
  return /* @__PURE__ */ import_react6.default.createElement(import_react6.default.Fragment, null, children.map((child, i) => {
    const p = (0, import_slate12.findNodePath)(editor, child);
    let ds = [];
    if (p) {
      const range = (0, import_slate12.getRange)(editor, p);
      ds = decorate([child, p]);
      for (const dec of decorations) {
        const d = import_slate13.Range.intersection(dec, range);
        if (d) {
          ds.push(d);
        }
      }
    }
    return (0, import_slate12.isElement)(child) ? /* @__PURE__ */ import_react6.default.createElement(
      ElementStatic,
      {
        key: i,
        components,
...
var renderComponentToHtml = (ReactDOMServer, Component, props) => {
  return (0, import_html_entities.decode)(
    ReactDOMServer.renderToStaticMarkup(import_react7.default.createElement(Component, props))
  );
};
