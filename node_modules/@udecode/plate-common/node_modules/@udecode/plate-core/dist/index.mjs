...
function Children({
  ...
  return /* @__PURE__ */ React6.createElement(React6.Fragment, null, children.map((child, i) => {
    const p = findNodePath2(editor, child);
    let ds = [];
    if (p) {
    ...
    return isElement4(child) ? /* @__PURE__ */ React6.createElement(
      ElementStatic,
      {
        key: i,
        components,
