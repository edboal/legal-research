...
var getInjectMatch = (editor, plugin) => {
  return (node, path) => {
    ...
    const element = (0, import_slate2.isElement)(node) ? node : void 0;
    if (_isElement && element) return false;
    if (_isBlock && (!element || !(0, import_slate2.isBlock)(editor, element))) return false;
    ...
    if (excludeBelowPlugins || maxLevel) {
      ...
      if (excludeBelowPlugins) {
        ...
        const isBelow = (0, import_slate2.getAboveNode)(editor, {
          at: path,
          match: (n) => (0, import_slate2.isElement)(n) && excludeTypes.includes(n.type)
        });
...
var createHotkey = (key) => {
  ...
  return (event) => {
    ...
    if (import_utils.IS_APPLE && isApple?.(event)) return true;
    if (!import_utils.IS_APPLE && isWindows?.(event)) return true;
    return false;
  };
};
var Hotkeys = {
...
var mergeDeepToNodes = (options) => {
  applyDeepToNodes({ ...options, apply: import_merge.default });
};
...
var withPlateHistory = ({ editor }) => (0, import_slate3.withHistory)(editor);
...
var resetEditorChildren = (editor, options) => {
  (0, import_slate_utils.replaceNodeChildren)(editor, {
    at: [],
...
var toggleBlock = (editor, options, editorNodesOptions) => {
  ...
  if (!type || !at) return;
  const isActive = (0, import_slate4.someNode)(editor, {
    ...editorNodesOptions,
    match: {
      type
    }
...
var htmlElementToLeaf = (editor, element) => {
  ...
  return deserializeHtmlNodeChildren(editor, element).reduce(
    (arr, child) => {
      if (!child) return arr;
      if ((0, import_slate5.isElement)(child)) {
        if (Object.keys(node).length > 0) {
          mergeDeepToNodes({
            node: child,
            query: {
              filter: ([n]) => (0, import_slate5.isText)(n)
            },
            source: node
          });
        }
        ...
        if ((0, import_slate5.isText)(child) && child.text) {
...
var withLength = ({
  ...
  const { apply } = editor;
  editor.apply = (operation) => {
    (0, import_slate6.withoutNormalizing)(editor, () => {
      apply(operation);
      const options = getOptions();
      if (options.maxLength) {
        const length = (0, import_slate6.getEditorString)(editor, []).length;
...
// src/lib/utils/normalizeDescendantsToDocumentFragment.ts
var isInlineNode = (editor) => (node) => (0, import_slate7.isText)(node) || (0, import_slate7.isElement)(node) && editor.isInline(node);
...
var normalize = (descendants, isInline, makeDefaultBlock) => {
  ...
  descendants = descendants.map((node) => {
    if ((0, import_slate7.isElement)(node)) {
      return {
        ...node,
        children: normalize(
          node.children,
...
var pluginInjectNodeProps = (editor, plugin, nodeProps, getElementPath) => {
  ...
  if (!transformProps && (!(0, import_utils8.isDefined)(nodeValue) || validNodeValues && !validNodeValues.includes(nodeValue) || nodeValue === defaultNodeValue)) {
    return;
  }
...
var pipeInsertFragment = (editor, injectedPlugins, { fragment, ...options }) => {
  (0, import_slate8.withoutNormalizing)(editor, () => {
...
var withSlate = (e, {
  ...
  if (selection) {
    ...
    const target = edge === "start" ? (0, import_slate9.getStartPoint)(editor, []) : (0, import_slate9.getEndPoint)(editor, []);
    (0, import_slate9.select)(editor, target);
  }
  if (editor.children.length > 0) {
    pipeNormalizeInitialValue(editor);
  }
  if (shouldNormalizeEditor) {
    (0, import_slate9.normalizeEditor)(editor, { force: true });
  }
  return editor;
};
...
var createPlateEditor = ({
  editor = (0, import_slate10.createTEditor)(),
  ...options
} = {}) => {
...
var getRenderNodeProps = ({
  ...
  nodeProps = pipeInjectNodeProps(
    editor,
    nodeProps,
    (node) => (0, import_slate_react3.findPath)(editor, node)
  );
...
var createComposing = (key) => (editor, event, {
  ...
  if (!!composing !== (0, import_slate_react4.isComposing)(editor)) return false;
  return true;
};
var Hotkeys2 = {
  ...Hotkeys,
...
var pipeRenderLeaf = (editor, renderLeafProp) => {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react8.default.createElement(DefaultLeaf, { ...ctxProps });
  };
};
...
var useEditableProps = ({
  ...
  const renderLeaf = import_react9.default.useMemo(() => {
...
var import_slate_react5 = require("@udecode/slate-react");
var useNodePath = (node) => {
  const editor = useEditorRef();
  return import_react10.default.useMemo(() => (0, import_slate_react5.findPath)(editor, node), [editor, node]);
};
...
var useSlateProps = ({
  ...
  const onChange = import_react11.default.useCallback(
    (newValue) => {
  ...
  const onValueChange = import_react11.default.useMemo(
    () => (value) => {
      onValueChangeProp?.({ editor, value });
    },
    [editor, onValueChangeProp]
  );
  const onSelectionChange = import_react11.default.useMemo(
    () => (selection) => {
...
function ElementContent({
  ...
  const Element = plugin.render?.node ?? import_slate_react6.DefaultElement;
  ...
  let component = /* @__PURE__ */ import_react12.default.createElement(Element, { ...nodeProps }, children);
...
var pluginRenderElement = (editor, plugin) => function render(nodeProps) {
  ...
  if (element.type === plugin.node.type) {
    return /* @__PURE__ */ import_react12.default.createElement(ElementProvider, { element, path, scope: plugin.key }, /* @__PURE__ */ import_react12.default.createElement(
      ElementContent,
      {
        editor,
        nodeProps,
...
var pipeRenderElement = (editor, renderElementProp) => {
  ...
  return function render(props) {
    ...
    return /* @__PURE__ */ import_react13.default.createElement(import_slate_react7.DefaultElement, { attributes: props.attributes, element: props.element }, props.children);
  };
};
...
function EditorHotkeysEffect({
  ...
  const editor = useEditorRef(id);
  return /* @__PURE__ */ import_react15.default.createElement(import_react15.default.Fragment, null, Object.entries(editor.shortcuts).map(([hotkeyString, hotkeyConfig]) => {
...
var EditorMethodsEffect = ({ id }) => {
  ...
  const memorizedStoreSetters = (0, import_react_utils2.useMemoOnce)(
    () => storeSetters,
    // eslint-disable-next-line react-hooks/exhaustive-deps
    []
  );
...
function EditorRefEffect({ id }) {
  ...
  return /* @__PURE__ */ import_react17.default.createElement(import_react17.default.Fragment, null, editor.pluginList.map((plugin) => /* @__PURE__ */ import_react17.default.createElement(EditorRefPluginEffect, { id, key: plugin.key, plugin })));
}
...
var EditorStateEffect = import_react18.default.memo(({ id }) => {
  const editorState = (0, import_slate_react8.useSlate)();
  ...
  const prevSelectionRef = import_react18.default.useRef(editorState.selection);
...
var isSelectionEqual = (a, b) => {
  if (!a && !b) return true;
  if (!a || !b) return false;
  return import_slate11.Range.equals(a, b);
};
...
function Plate(props) {
  ...
  const scrollRef = import_react20.default.useRef(null);
...
var import_slate_react11 = require("@udecode/slate-react");
...
var PlateControllerEffect = ({
  ...
  const focused = (0, import_slate_react9.useFocused)();
...
function PlateSlate({
  ...
  const editor = useEditorRef(id);
  let aboveSlate = /* @__PURE__ */ import_react22.default.createElement(import_slate_react10.Slate, { ...slateProps }, children);
  editor.pluginList?.forEach((plugin) => {
    const {
      render: { aboveSlate: AboveSlate }
    } = plugin;
    if (AboveSlate) aboveSlate = /* @__PURE__ */ import_react22.default.createElement(AboveSlate, null, aboveSlate);
  });
  return aboveSlate;
}
...
var PlateContent = import_react23.default.forwardRef(
  ({ autoFocusOnEditable, renderEditable, ...props }, ref) => {
    ...
    const editableRef = (0, import_react23.useRef)(null);
    const combinedRef = (0, import_react_utils3.useComposedRef)(ref, editableRef);
    const editable = /* @__PURE__ */ import_react23.default.createElement(import_slate_react12.Editable, { ref: combinedRef, ...editableProps });
    ...
    editor.pluginList.forEach((plugin) => {
      ...
      if (AfterEditable) {
        afterEditable = /* @__PURE__ */ import_react23.default.createElement(import_react23.default.Fragment, null, afterEditable, /* @__PURE__ */ import_react23.default.createElement(AfterEditable, { ...editableProps }));
      }
      if (BeforeEditable) {
        beforeEditable = /* @__PURE__ */ import_react23.default.createElement(import_react23.default.Fragment, null, beforeEditable, /* @__PURE__ */ import_react23.default.createElement(BeforeEditable, { ...editableProps }));
      }
    });
    let aboveEditable = /* @__PURE__ */ import_react23.default.createElement(import_react23.default.Fragment, null, beforeEditable, renderEditable ? renderEditable(editable) : editable, /* @__PURE__ */ import_react23.default.createElement(EditorMethodsEffect, { id }), /* @__PURE__ */ import_react23.default.createElement(EditorHotkeysEffect, { id, editableRef }), /* @__PURE__ */ import_react23.default.createElement(EditorStateEffect, { id }), /* @__PURE__ */ import_react23.default.createElement(EditorRefEffect, { id }), /* @__PURE__ */ import_react23.default.createElement(PlateControllerEffect, { id }), afterEditable);
    editor.pluginList.forEach((plugin) => {
      const {
        render: { aboveEditable: AboveEditable }
      } = plugin;
      if (AboveEditable)
        aboveEditable = /* @__PURE__ */ import_react23.default.createElement(AboveEditable, null, aboveEditable);
    });
    const readOnly = props.readOnly ?? false;
    const prevReadOnly = import_react23.default.useRef(readOnly);
    import_react23.default.useEffect(() => {
      if (autoFocusOnEditable && prevReadOnly.current && !readOnly) {
        (0, import_slate_react11.focusEditorEdge)(editor, { edge: "end" });
      }
...
function usePlateEditor(options = {}, deps = []) {
  return (0, import_react_utils4.useMemoOnce)(
    () => {
