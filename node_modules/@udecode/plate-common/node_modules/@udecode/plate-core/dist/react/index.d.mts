...
import { TElement, Value, TEditor, TNodeEntry, ValueOf, TSelection, TText, TDescendant, TDecoratedRange, TNode } from '@udecode/slate';
import * as _udecode_slate_react from '@udecode/slate-react';
import { TEditableProps, TRenderElementProps, TRenderLeafProps, SlateProps } from '@udecode/slate-react';
import { P as PluginConfig, i as ToggleBlockOptions, S as SlateEditor, a as SlatePlugin, A as AnyPluginConfig, E as ExtendEditor$1, a7 as CorePlugin, r as BaseWithSlateOptions, q as InferPlugins, j as Nullable, W as WithRequiredKey, M as InferOptions, O as InferApi, Q as InferTransforms, o as BaseEditor, u as BasePlugin, K as WithAnyKey, U as NodeComponent, e as AnySlatePlugin, X as SlatePluginConfig, c as SlatePluginContext, R as BasePluginContext, l as ParserOptions, V as HandlerReturnType, F as BaseTransformOptions, y as BaseDeserializer, x as BaseSerializer, z as BaseHtmlDeserializer, D as BaseInjectProps, G as GetInjectNodePropsOptions, m as GetInjectNodePropsReturnType } from '../withSlate-DBvOuQn6.mjs';
import { UnionToIntersection, AnyObject, Modify } from '@udecode/utils';
...
declare const usePath: (pluginKey?: string) => slate.Path | undefined;
...
declare const PlateStoreProvider: React__default.FC<jotai_x.ProviderProps<{
    ...
    editor: PlateEditor;
    scrollRef: React__default.RefObject<HTMLDivElement>;
}>>;
...
declare const usePlateSelectors: (id?: string, options?: UsePlateEditorStoreOptions) => {
    ...
    containerRef: (options?: string | jotai_x.UseAtomOptions) => React__default.RefObject<HTMLDivElement>;
    editor: (options?: string | jotai_x.UseAtomOptions) => PlateEditor;
    scrollRef: (options?: string | jotai_x.UseAtomOptions) => React__default.RefObject<HTMLDivElement>;
...
declare const usePlateActions: (id?: string, options?: UsePlateEditorStoreOptions) => {
    ...
    containerRef: (options?: string | jotai_x.UseAtomOptions) => (args_0: React__default.RefObject<HTMLDivElement>) => void;
    editor: (options?: string | jotai_x.UseAtomOptions) => (args_0: PlateEditor) => void;
    scrollRef: (options?: string | jotai_x.UseAtomOptions) => (args_0: React__default.RefObject<HTMLDivElement>) => void;
...
declare const usePlateStates: (id?: string, options?: UsePlateEditorStoreOptions) => {
    ...
    containerRef: (options?: string | jotai_x.UseAtomOptions) => [React__default.RefObject<HTMLDivElement>, (args_0: React__default.RefObject<HTMLDivElement>) => void];
    editor: (options?: string | jotai_x.UseAtomOptions) => [PlateEditor, (args_0: PlateEditor) => void];
    scrollRef: (options?: string | jotai_x.UseAtomOptions) => [React__default.RefObject<HTMLDivElement>, (args_0: React__default.RefObject<HTMLDivElement>) => void];
...
declare const useEditorContainerRef: (id?: string) => React$1.RefObject<HTMLDivElement>;
declare const useEditorScrollRef: (id?: string) => React$1.RefObject<HTMLDivElement>;
/** Returns the scrollRef if it exists, otherwise returns the containerRef. */
declare const useScrollRef: (id?: string) => React$1.RefObject<HTMLDivElement>;
...
type PlatePluginMethods<C extends AnyPluginConfig = PluginConfig> = {
    configure: (config: ((ctx: PlatePluginContext<C>) => PlatePluginConfig$2<C['key'], InferOptions<C>, InferApi<C>, InferTransforms<C>>) | PlatePluginConfig$2<C['key'], InferOptions<C>, InferApi<C>, InferTransforms<C>>) => PlatePlugin<C>;
    ...
    extend: <EO = {}, EA = {}, ET = {}>(extendConfig: ((ctx: PlatePluginContext<C>) => PlatePluginConfig$2<C['key'], InferOptions<C>, InferApi<C>, InferTransforms<C>, EO, EA, ET>) | PlatePluginConfig$2<C['key'], InferOptions<C>, InferApi<C>, InferTransforms<C>, EO, EA, ET>) => PlatePlugin<PluginConfig<C['key'], EO & InferOptions<C>, EA & InferApi<C>, ET & InferTransforms<C>>>;
...
type PlatePluginConfig$2<K extends string = any, O = {}, A = {}, T = {}, EO = {}, EA = {}, ET = {}> = Partial<Omit<PlatePlugin<PluginConfig<K, Partial<O>, A, T>>, keyof PlatePluginMethods | 'api' | 'node' | 'optionsStore' | 'transforms' | 'useOptionsStore'> & {
    api: EA;
...
type PlatePluginConfig$1<K extends string = any, O = {}, A = {}, T = {}> = Omit<Partial<Modify<PlatePlugin<PluginConfig<K, O, A, T>>, {
    node: Partial<PlatePlugin<PluginConfig<K, O, A, T>>['node']>;
...
declare const createPlatePlugin: <K extends string = any, O = {}, A = {}, T = {}>(config?: ((editor: PlateEditor) => PlatePluginConfig$1<K, O, A, T>) | PlatePluginConfig$1<K, O, A, T>) => PlatePlugin<PluginConfig<K, O, A, T>>;
/**
...
declare const omitPluginContext: <T extends PlatePluginContext<AnyPlatePlugin>>(ctx: T) => Omit<T, "api" | "type" | "getOption" | "setOption" | "setOptions" | "getOptions" | "tf" | "editor" | "plugin" | "useOption">;

type PlatePluginConfig<C extends AnyPluginConfig, EO = {}, EA = {}, ET = {}> = Omit<Partial<PlatePlugin<PluginConfig<C['key'], EO & InferOptions<C>, EA & InferApi<C>, ET & InferTransforms<C>>>>, keyof PlatePluginMethods | 'api' | 'node' | 'options' | 'transforms'> & {
 ...
 */
declare function toPlatePlugin<C extends AnyPluginConfig, EO = {}, EA = {}, ET = {}>(basePlugin: SlatePlugin<C>, extendConfig?: ((ctx: PlatePluginContext<C>) => PlatePluginConfig<C, EO, EA, ET>) | PlatePluginConfig<C, EO, EA, ET>): PlatePlugin<PluginConfig<C['key'], EO & InferOptions<C>, EA & InferApi<C>, ET & InferTransforms<C>>>;
...
declare const useEditableProps: ({ disabled, readOnly: readOnlyProp, ...editableProps }?: Omit<TEditableProps, "decorate"> & Pick<PlateProps, "decorate">) => TEditableProps;

declare const useNodePath: (node: TNode) => slate.Path | undefined;
