...
import { TElement, TText, Value, TDescendant, TNodeEntry, TEditor, TRange, TSelection } from '@udecode/slate';
...
import { TRenderElementProps, TRenderLeafProps } from '@udecode/slate-react';
...
type SlateRenderElementProps<N extends TElement = TElement, C extends AnyPluginConfig = PluginConfig> = SlateRenderNodeProps<C> & TRenderElementProps<N>;
type SlateRenderNodeProps<C extends AnyPluginConfig = PluginConfig> = SlatePluginContext<C> & {
    className?: string;
    /** @see {@link NodeProps} */
    nodeProps?: AnyObject;
};
type SlateRenderLeafProps<N extends TText = TText, C extends AnyPluginConfig = PluginConfig> = SlateRenderNodeProps<C> & TRenderLeafProps<N>;
...
export { type Serializer as $, type AnyPluginConfig as A, type BoxStaticProps as B, type CreateSlateEditorOptions as C, type BaseInjectProps as D, type ExtendEditor as E, type BaseTransformOptions as F, type GetInjectNodePropsOptions as G, type HtmlDeserializer as H, type InferConfig as I, type ExtendConfig as J, type WithAnyKey as K, type LengthConfig as L, type InferOptions as M, type NodeComponents as N, type InferApi as O, type PluginConfig as P, type InferTransforms as Q, type BasePluginContext as R, type SlateEditor as S, type TextStaticProps as T, type NodeComponent as U, type HandlerReturnType as V, type WithRequiredKey as W, type SlatePluginConfig as X, type Parser as Y, type TransformOptions as Z, type Deserializer as _, type SlatePlugin as a, type HtmlSerializer as a0, type Decorate as a1, type InjectNodeProps as a2, type NodeStaticProps as a3, type NodeStaticWrapperComponent as a4, type NodeStaticWrapperComponentReturnType as a5, type NodeStaticWrapperComponentProps as a6, type CorePlugin as a7, type GetCorePluginsOptions as a8, getCorePlugins as a9, type DebugConfig as aa, type DebugErrorType as ab, PlateError as ac, type LogLevel as ad, DebugPlugin as ae, type SlatePluginMethods as b, type SlatePluginContext as c, type AnyEditorPlugin as d, type AnySlatePlugin as e, type SlateRenderElementProps as f, type SlateRenderLeafProps as g, type SlateRenderNodeProps as h, type ToggleBlockOptions as i, type Nullable as j, type EditorPlugin as k, type ParserOptions as l, type GetInjectNodePropsReturnType as m, type SlatePlugins as n, type BaseEditor as o, type TSlateEditor as p, type InferPlugins as q, type BaseWithSlateOptions as r, type WithSlateOptions as s, createSlateEditor as t, type BasePlugin as u, type BasePluginNode as v, withSlate as w, type BaseSerializer as x, type BaseDeserializer as y, type BaseHtmlDeserializer as z };
