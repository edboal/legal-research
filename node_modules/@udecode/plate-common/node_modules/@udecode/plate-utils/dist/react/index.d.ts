...
import { AnyPlatePlugin, PlateRenderElementProps, PlateRenderLeafProps, PlateEditor } from '@udecode/plate-core/react';
import { BoxProps, TextProps } from '@udecode/react-utils';
import * as _udecode_slate from '@udecode/slate';
import { TElement, TText, TEditor, TNode, QueryNodeOptions } from '@udecode/slate';
import { AnyObject } from '@udecode/utils';
import { Location, Path } from 'slate';
import { GetSelectionFragmentOptions, GetFragmentPropOptions } from '@udecode/slate-utils';
...
declare const getLastBlockDOMNode: (editor: PlateEditor) => HTMLElement | undefined;
...
declare const selectSiblingNodePoint: (editor: TEditor, { at, focus, node, reverse, }?: {
    at?: Path;
    focus?: boolean;
    node?: TNode;
    reverse?: boolean;
...
declare const useLastBlock: ({ deps, enabled, }: {
    enabled: boolean;
    deps?: React.DependencyList;
}) => _udecode_slate.TElement | null;

interface UseLastBlockDOMNodeOptions {
    enabled: boolean;
    deps?: React.DependencyList;
}
declare const useLastBlockDOMNode: (editor: PlateEditor, { deps, enabled }: UseLastBlockDOMNodeOptions) => HTMLElement;
...
declare function useSelectionWithinBlock(): boolean | undefined;
declare function useSelectionAcrossBlocks(): boolean | undefined;

declare const useSelectionFragment: (options?: GetSelectionFragmentOptions) => _udecode_slate.TElement[];
declare const useSelectionFragmentProp: ({ structuralTypes, ...options }?: GetSelectionFragmentOptions & GetFragmentPropOptions) => string | undefined;

export { type CreateHOCOptions, type PlaceholderProps, PlateElement, type PlateElementProps, PlateLeaf, type PlateLeafProps, type SelectEditorOptions, createNodeHOC, createNodesHOC, createNodesWithHOC, getLastBlockDOMNode, selectEditor, selectSiblingNodePoint, useEditorString, useFormInputProps, useLastBlock, useLastBlockDOMNode, useMarkToolbarButton, useMarkToolbarButtonState, usePlaceholderState, usePlateElement, usePlateLeaf, useRemoveNodeButton, useSelectionAcrossBlocks, useSelectionCollapsed, useSelectionExpanded, useSelectionFragment, useSelectionFragmentProp, useSelectionWithinBlock };
